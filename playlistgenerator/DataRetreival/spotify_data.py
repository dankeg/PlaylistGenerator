...
def get_track_data(track_id):
    ...
    try:
        ...
        audio_features = sp.audio_features([track_id])[
            0
        ]  # Returns a list, we want the first item
        if audio_features:
            track_data.update(
                {
        ...
        if audio_analysis:
            track_data["audio_analysis"] = {
                ...
                "sections": audio_analysis[
                    "sections"
                ],  # List of sections with detailed info
                "segments": audio_analysis[
                    "segments"
                ],  # List of segments with detailed info
...
def get_user_profile(user_id):
    ...
    try:
        ...
        profile_data = {
            ...
            "profile_image": (
                user_profile["images"][0]["url"] if user_profile["images"] else None
            ),
