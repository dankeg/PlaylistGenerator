...
data = pd.read_csv("playlistgenerator/Datasets/cleaned_spotify_songs.csv")
...
plt.savefig("sentiment_scores_by_topic.png")
plt.close()

# Save the data
data.to_csv("playlistgenerator/Datasets/processed_spotify_songs_step3.csv", index=False)
